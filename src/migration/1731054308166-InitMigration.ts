...
export class InitMigration1731054308166 implements MigrationInterface {
  name = 'InitMigration1731054308166';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "profile" ("profileId" character varying(40) NOT NULL, CONSTRAINT "PK_61a193410d652adedb69f7ad680" PRIMARY KEY ("profileId"))`
    );
    await queryRunner.query(
      `CREATE TABLE "application" ("id" SERIAL NOT NULL, "chainId" integer NOT NULL, "applicationId" character varying NOT NULL, "poolId" integer NOT NULL, "profileProfileId" character varying(40), CONSTRAINT "UQ_a04ad3e9cf6c137dad17f7905f6" UNIQUE ("applicationId", "poolId", "chainId"), CONSTRAINT "PK_569e0c3e863ebdf5f2408ee1670" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "evaluation" ("id" SERIAL NOT NULL, "evaluator" character varying(40) NOT NULL, "evaluatorType" "public"."evaluation_evaluatortype_enum" NOT NULL, "summary" character varying NOT NULL, "evaluatorScore" integer NOT NULL, "metadataCid" character varying NOT NULL, "applicationId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_566857ce7db15aa0fb1930b4cdf" UNIQUE ("evaluator", "applicationId"), CONSTRAINT "PK_b72edd439b9db736f55b584fa54" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
